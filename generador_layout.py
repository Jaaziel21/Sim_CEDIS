...
def generar_layout(seed: int, ancho: int, alto: int, estaciones: int) -> Dict:
    ...
    ancho_parking, alto_parking = 500, 8
    x_parking0, y_parking0 = 100, alto - (alto_parking + 5)
...
def main():
    ...
    parser.add_argument("--estaciones", type=int, default=None)
    ...
    aplicar_defaults_desde_config(parser, "generador_layout")
    ...
    if args.prefijo is not None and not args.escenario:
